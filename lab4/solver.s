...
0000000000000368 <.note.gnu.build-id>:
 ...
 377:	00 36                	add    BYTE PTR [rsi],dh
 379:	57                   	push   rdi
 37a:	5c                   	pop    rsp
 37b:	b4 f5                	mov    ah,0xf5
 37d:	7c 2d                	jl     3ac <__abi_tag+0x20>
 37f:	44 6e                	rex.R outs dx,BYTE PTR ds:[rsi]
 381:	ce                   	(bad)  
 382:	98                   	cwde   
 383:	8e 42 f2             	mov    es,WORD PTR [rdx-0xe]
 386:	03                   	.byte 0x3
 387:	bc ef fc d7 11       	mov    esp,0x11d7fcef
...
0000000000001070 <_start>:
    ...
    1088:	48 8d 3d a0 01 00 00 	lea    rdi,[rip+0x1a0]        # 122f <main>
...
0000000000001159 <solver>:
    ...
    1178:	48 b8 48 65 6c 6c 6f 	movabs rax,0x6f57206f6c6c6548
    117f:	20 57 6f 
    1182:	ba 72 6c 64 21       	mov    edx,0x21646c72
    1187:	48 89 45 e0          	mov    QWORD PTR [rbp-0x20],rax
    118b:	48 89 55 e8          	mov    QWORD PTR [rbp-0x18],rdx
    118f:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    1193:	48 83 c0 18          	add    rax,0x18
    1197:	48 8b 00             	mov    rax,QWORD PTR [rax]
    119a:	48 89 45 c8          	mov    QWORD PTR [rbp-0x38],rax
    119e:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    11a2:	48 83 c0 20          	add    rax,0x20
    11a6:	48 8b 00             	mov    rax,QWORD PTR [rax]
    11a9:	48 89 45 d0          	mov    QWORD PTR [rbp-0x30],rax
    11ad:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    11b1:	48 83 c0 28          	add    rax,0x28
    11b5:	48 8b 00             	mov    rax,QWORD PTR [rax]
    11b8:	48 89 45 d8          	mov    QWORD PTR [rbp-0x28],rax
    11bc:	48 81 45 d8 ab 00 00 	add    QWORD PTR [rbp-0x28],0xab
    11c3:	00 
    11c4:	48 8b 45 c8          	mov    rax,QWORD PTR [rbp-0x38]
    11c8:	48 8b 55 b8          	mov    rdx,QWORD PTR [rbp-0x48]
    11cc:	48 89 c6             	mov    rsi,rax
    11cf:	48 8d 05 2e 0e 00 00 	lea    rax,[rip+0xe2e]        # 2004 <_IO_stdin_used+0x4>
    11d6:	48 89 c7             	mov    rdi,rax
    11d9:	b8 00 00 00 00       	mov    eax,0x0
    11de:	ff d2                	call   rdx
    11e0:	48 8b 45 d0          	mov    rax,QWORD PTR [rbp-0x30]
    11e4:	48 8b 55 b8          	mov    rdx,QWORD PTR [rbp-0x48]
    11e8:	48 89 c6             	mov    rsi,rax
    11eb:	48 8d 05 28 0e 00 00 	lea    rax,[rip+0xe28]        # 201a <_IO_stdin_used+0x1a>
    11f2:	48 89 c7             	mov    rdi,rax
    11f5:	b8 00 00 00 00       	mov    eax,0x0
    11fa:	ff d2                	call   rdx
    11fc:	48 8b 45 d8          	mov    rax,QWORD PTR [rbp-0x28]
    1200:	48 8b 55 b8          	mov    rdx,QWORD PTR [rbp-0x48]
    1204:	48 89 c6             	mov    rsi,rax
    1207:	48 8d 05 22 0e 00 00 	lea    rax,[rip+0xe22]        # 2030 <_IO_stdin_used+0x30>
    120e:	48 89 c7             	mov    rdi,rax
    1211:	b8 00 00 00 00       	mov    eax,0x0
    1216:	ff d2                	call   rdx
    1218:	90                   	nop
    1219:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8]
    121d:	64 48 2b 04 25 28 00 	sub    rax,QWORD PTR fs:0x28
    1224:	00 00 
    1226:	74 05                	je     122d <solver+0xd4>
    1228:	e8 33 fe ff ff       	call   1060 <__stack_chk_fail@plt>
    122d:	c9                   	leave  
    122e:	c3                   	ret    
...
000000000000122f <main>:
    ...
    1233:	55                   	push   rbp
    1234:	48 89 e5             	mov    rbp,rsp
    1237:	48 83 ec 20          	sub    rsp,0x20
    123b:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
    1242:	00 00 
    1244:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
    1248:	31 c0                	xor    eax,eax
    124a:	48 b8 2a 2a 20 6d 61 	movabs rax,0x206e69616d202a2a
    1251:	69 6e 20 
    1254:	48 ba 3d 20 25 70 0a 	movabs rdx,0xa7025203d
    125b:	00 00 00 
    125e:	48 89 45 e0          	mov    QWORD PTR [rbp-0x20],rax
    1262:	48 89 55 e8          	mov    QWORD PTR [rbp-0x18],rdx
    1266:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    126a:	48 8d 15 be ff ff ff 	lea    rdx,[rip+0xffffffffffffffbe]        # 122f <main>
    1271:	48 89 d6             	mov    rsi,rdx
    1274:	48 89 c7             	mov    rdi,rax
    1277:	b8 00 00 00 00       	mov    eax,0x0
    127c:	e8 bf fd ff ff       	call   1040 <printf@plt>
    1281:	48 8b 05 58 2d 00 00 	mov    rax,QWORD PTR [rip+0x2d58]        # 3fe0 <printf@GLIBC_2.2.5>
    1288:	48 89 c7             	mov    rdi,rax
    128b:	e8 c9 fe ff ff       	call   1159 <solver>
    1290:	b8 00 00 00 00       	mov    eax,0x0
    1295:	48 8b 55 f8          	mov    rdx,QWORD PTR [rbp-0x8]
    1299:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
    12a0:	00 00 
    12a2:	74 05                	je     12a9 <main+0x7a>
    12a4:	e8 b7 fd ff ff       	call   1060 <__stack_chk_fail@plt>
    12a9:	c9                   	leave  
    12aa:	c3                   	ret    
...
0000000000002000 <_IO_stdin_used>:
    ...
    2007:	61                   	(bad)  
    2008:	72 79                	jb     2083 <__GNU_EH_FRAME_HDR+0x3b>
    200a:	20 20                	and    BYTE PTR [rax],ah
    200c:	20 20                	and    BYTE PTR [rax],ah
    200e:	20 20                	and    BYTE PTR [rax],ah
    2010:	3a 20                	cmp    ah,BYTE PTR [rax]
    2012:	25 30 31 36 6c       	and    eax,0x6c363130
    2017:	78 0a                	js     2023 <_IO_stdin_used+0x23>
    2019:	00 73 6f             	add    BYTE PTR [rbx+0x6f],dh
    201c:	6c                   	ins    BYTE PTR es:[rdi],dx
    201d:	76 65                	jbe    2084 <__GNU_EH_FRAME_HDR+0x3c>
    201f:	72 5f                	jb     2080 <__GNU_EH_FRAME_HDR+0x38>
    2021:	72 62                	jb     2085 <__GNU_EH_FRAME_HDR+0x3d>
    2023:	70 20                	jo     2045 <_IO_stdin_used+0x45>
    2025:	20 3a                	and    BYTE PTR [rdx],bh
    2027:	20 25 30 31 36 6c    	and    BYTE PTR [rip+0x6c363130],ah        # 6c36515d <_end+0x6c361145>
    202d:	78 0a                	js     2039 <_IO_stdin_used+0x39>
    202f:	00 72 65             	add    BYTE PTR [rdx+0x65],dh
    2032:	74 75                	je     20a9 <__GNU_EH_FRAME_HDR+0x61>
    2034:	72 6e                	jb     20a4 <__GNU_EH_FRAME_HDR+0x5c>
    2036:	5f                   	pop    rdi
    2037:	61                   	(bad)  
    2038:	64 64 72 20          	fs fs jb 205c <__GNU_EH_FRAME_HDR+0x14>
    203c:	3a 20                	cmp    ah,BYTE PTR [rax]
    203e:	25 30 31 36 6c       	and    eax,0x6c363130
    2043:	78 0a                	js     204f <__GNU_EH_FRAME_HDR+0x7>
	...

Disassembly of section .eh_frame_hdr:

0000000000002048 <__GNU_EH_FRAME_HDR>:
    2048:	01 1b                	add    DWORD PTR [rbx],ebx
    204a:	03 3b                	add    edi,DWORD PTR [rbx]
    204c:	3c 00                	cmp    al,0x0
    204e:	00 00                	add    BYTE PTR [rax],al
    2050:	06                   	(bad)  
    2051:	00 00                	add    BYTE PTR [rax],al
    2053:	00 d8                	add    al,bl
    2055:	ef                   	out    dx,eax
    2056:	ff                   	(bad)  
    2057:	ff 70 00             	push   QWORD PTR [rax+0x0]
    205a:	00 00                	add    BYTE PTR [rax],al
    205c:	f8                   	clc    
    205d:	ef                   	out    dx,eax
    205e:	ff                   	(bad)  
    205f:	ff 98 00 00 00 18    	call   FWORD PTR [rax+0x18000000]
    2065:	f0 ff                	lock (bad) 
    2067:	ff b0 00 00 00 28    	push   QWORD PTR [rax+0x28000000]
    206d:	f0 ff                	lock (bad) 
    206f:	ff 58 00             	call   FWORD PTR [rax+0x0]
    2072:	00 00                	add    BYTE PTR [rax],al
    2074:	11 f1                	adc    ecx,esi
    2076:	ff                   	(bad)  
    2077:	ff c8                	dec    eax
    2079:	00 00                	add    BYTE PTR [rax],al
    207b:	00 e7                	add    bh,ah
    207d:	f1                   	int1   
    207e:	ff                   	(bad)  
    207f:	ff                   	(bad)  
    2080:	e8                   	.byte 0xe8
...
0000000000002088 <__FRAME_END__-0xc8>:
    ...
    2095:	78 10                	js     20a7 <__GNU_EH_FRAME_HDR+0x5f>
    ...
    20a8:	c8 ef ff ff          	enter  0xffef,0xff
    20ac:	26 00 00             	es add BYTE PTR [rax],al
    ...
    20e7:	00 58 ef             	add    BYTE PTR [rax-0x11],bl
    20ea:	ff                   	(bad)  
    20eb:	ff 20                	jmp    QWORD PTR [rax]
	...
    20f5:	00 00                	add    BYTE PTR [rax],al
    20f7:	00 14 00             	add    BYTE PTR [rax+rax*1],dl
    20fa:	00 00                	add    BYTE PTR [rax],al
    20fc:	74 00                	je     20fe <__GNU_EH_FRAME_HDR+0xb6>
    20fe:	00 00                	add    BYTE PTR [rax],al
    2100:	60                   	(bad)  
    2101:	ef                   	out    dx,eax
    2102:	ff                   	(bad)  
    2103:	ff 10                	call   QWORD PTR [rax]
	...
    ...
    2129:	02 cd                	add    cl,ch
    212b:	0c 07                	or     al,0x7
    212d:	08 00                	or     BYTE PTR [rax],al
    212f:	00 1c 00             	add    BYTE PTR [rax+rax*1],bl
    2132:	00 00                	add    BYTE PTR [rax],al
    2134:	ac                   	lods   al,BYTE PTR ds:[rsi]
    2135:	00 00                	add    BYTE PTR [rax],al
    2137:	00 f7                	add    bh,dh
    2139:	f0 ff                	lock (bad) 
    213b:	ff                   	(bad)  
    213c:	7c 00                	jl     213e <__GNU_EH_FRAME_HDR+0xf6>
    213e:	00 00                	add    BYTE PTR [rax],al
    2140:	00 45 0e             	add    BYTE PTR [rbp+0xe],al
    2143:	10 86 02 43 0d 06    	adc    BYTE PTR [rsi+0x60d4302],al
    2149:	02 73 0c             	add    dh,BYTE PTR [rbx+0xc]
    214c:	07                   	(bad)  
    214d:	08 00                	or     BYTE PTR [rax],al
	...
...
0000000000003dc0 <_DYNAMIC>:
    ...
    3de7:	00 ac 12 00 00 00 00 	add    BYTE PTR [rdx+rdx*1+0x0],ch
